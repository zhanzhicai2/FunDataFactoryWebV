        ...
        <el-col :xs="12" :sm="12" :lg="4" class="card-panel-col">
          <div class="card-panel">
            ...
            <div class="card-panel-description">
              ...
              <div class="card-panel-text">{{ item.case }}
              </div>
            </div>
          </div>
        </el-col>
        <el-col :xs="12" :sm="12" :lg="4" class="card-panel-col">
          <div class="card-panel">
            ...
            <div class="card-panel-description">
              ...
              <div class="card-panel-text">{{ item.project }}
              </div>
            </div>
          </div>
        </el-col>
        <el-col :xs="12" :sm="12" :lg="4" class="card-panel-col">
          <div class="card-panel">
            ...
            <div class="card-panel-description">
              ...
              <div class="card-panel-text">{{ item.group }}
              </div>
            </div>
          </div>
        </el-col>
        <el-col :xs="12" :sm="12" :lg="4" class="card-panel-col">
          <div class="card-panel">
            ...
            <div class="card-panel-description">
              ...
              <div class="card-panel-text">{{ item.success_rate }}
              </div>
            </div>
          </div>
        </el-col>
        <el-col :xs="12" :sm="12" :lg="4" class="card-panel-col">
          <div class="card-panel">
            ...
            <div class="card-panel-description">
              ...
              <div class="card-panel-text">{{ item.log }}
              </div>
            </div>
          </div>
        </el-col>
