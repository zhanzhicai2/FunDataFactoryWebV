      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-col :space="18">
              <el-form ref="form" size="small" :inline="true" :model="listQuery">
                <el-form-item label="项目：">
                  <el-select value="" clearable filterable placeholder="请选择项目" class="groupSelect">
                    <el-option
        ...
        <el-row :gutter="10">
          <el-col v-for="(item,i) in lists" :key="i", :lg="8" :xl="6" style="padding: 15px">
            <el-card class="case-card" :body-style="{padding: '10'}" shadow="hover">
...
export default {
  ...
  methods:{
    ...
    async onSelect(item){
      console.log(item)
      await readProject(item.projects_id)
