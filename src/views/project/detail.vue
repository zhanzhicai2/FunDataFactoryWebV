    ...
    <el-card class="project-detail-card">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="成员列表" name="user">
          <el-row>
            <el-col :span="16">
              <el-tooltip effect="dark" content="只有项目负责人和组长可以添加成员哦" aria-placeholder="top">
            ...
            <el-col :span="8">
              <div style="width: 100%;">
                <div id="project-left" style="width: 55%;float: left;padding: 0px 5px">
                  <el-input v-model="listQuery.search" size="small" clearable placeholder="请输入用户名或者邮箱" />
                </div>
              ...
              <div style="padding: 20px">
                <el-form ref="projectForm" :rules="projectRules" :model="projectForm" size="small" label-width="120px">
                  <el-form-item label="项目名称" prop="project_name">
                    <el-input v-model="projectForm.projects_name" placeholder="请输入项目名称" />
                  </el-form-item>
                  <el-form-item label="项目目录名" prop="directory">
                    <el-input v-model="projectForm.directory" placeholder="请输入项目脚本目录名" />
                  </el-form-item>
                  <el-form-item label="项目负责人" prop="owner">
                    <el-tooltip effect="dark" content="输入用户姓名/用户名/邮箱号即可搜索哦~" placeholder="top">
                      <el-select
                  ...
                  <el-form-item label="项目描述" prop="description">
                    <el-input v-model="projectForm.description" placeholder="请输入git项目描述" />
                  </el-form-item>
                  <el-form-item v-if="projectForm.pull_type ===1" label="公钥" prop="rsa_pub_key">
                    <el-input v-model="projectForm.rsa_pub_key" style="width: 300px" :disabled="true" />
                    <el-tooltip effect="dark" content="点击复制按钮即可复制公钥哦" placeholder="top">
                      <span>
  ...
  data() {
    return {
      ...
      listQuery: {
        page: 1,
        limit: 20,
        projects_id: this.$route.params.id,
        search: null
      },
      users: [],
      owners: [],
